  ...
  <script src="{{  asset('vendor/assets/js/vendor/jquery-2.2.4.min.js') }}"></script>
  <!-- bootstrap 4 js -->
  ...
  <script src="{{  asset('vendor/assets/js/metisMenu.min.js') }}"></script>
  <script src="{{  asset('vendor/assets/js/jquery.slimscroll.min.js') }}"></script>
  ...
  <script src="{{  asset('vendor/assets/js/line-chart.js') }}"></script>
  <!-- all pie chart -->
  <script src="{{  asset('vendor/assets/js/pie-chart.js') }}"></script>
  <!-- others plugins -->
