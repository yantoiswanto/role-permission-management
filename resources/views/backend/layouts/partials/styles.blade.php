...
<link rel="stylesheet" href="{{  asset('vendor/assets/css/metisMenu.css') }}">
...
<!-- others css -->
<link rel="stylesheet" href="{{  asset('vendor/assets/css/typography.css') }}">
<link rel="stylesheet" href="{{  asset('vendor/assets/css/default-css.css') }}">
...
<!-- modernizr css -->
<script src="{{  asset('vendor/assets/js/vendor/modernizr-2.8.3.min.js') }}"></script>